...
@section('content')
 ...
 <!-- Shop Detail Start -->
    <div class="container-fluid pb-5">
        <span><i class="fas fa-arrow-circle-left text-dark ms-5 my-3" onclick="history.back()"></i> Back</span>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="margin-top:7px;width: 130px;">
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style="width:100px;height:220px;" src="{{asset('storage/'.$pizza->image)}}" alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="{{route('user#detail',$pizza->id)}}"><i class="fas fa-info-circle"></i></a>
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                <small>{{$pizza->view_count}}<i class="fas fa-eye"></i></small>
                            </div>
                        </div>
                    </div>
                    {{-- start-item section --}}
...
<script>
     $(document).ready(function(){ 
        $('#addCartBtn').click(function(){
            ...
            // take value form input box and assign
            ...
            $source ={
             ...
             $.ajax({
                ...
                success:function(response){
                    ...
                    //tracting for getting if statement 
