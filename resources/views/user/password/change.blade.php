                                    ...
                                    {{-- to show a message after delete a category list item --}}
                                           <div class="col-lg-12">
                                               <div class="alert alert-success bg-success text-white text-center alert-dismissible fade show" role="alert">
                                                <i class="fas fa-cloud-download-alt"></i> {{session('passwordSuccess')}}
                               ...
                               {{-- to show a message after delete a category list item --}}
                                      <div class="col-lg-12">
                                          <div class="alert alert-danger bg-danger text-white text-center alert-dismissible fade show" role="alert">
                                            <i class="fas fa-exclamation-triangle"></i> {{session('notMatch')}}
                                              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                          </div>
                                      </div>
                                  {{-- to show a message after delete a category list item --}}
                                  @endif
                                    ...
                                    <form action="{{route('user#changePasswordWork')}}" method="post" novalidate="novalidate">
                                        @csrf
                                        ...
                                        <div>
                                            <button id="payment-button" type="submit" class="btn btn-lg btn-success btn-block bg-dark text-white">
                                                <i class="fas fa-key me-3"></i><span id="payment-button-amount">Change Password</span>
