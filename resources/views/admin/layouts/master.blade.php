...
<head>
    ...
    <link href="{{asset('admin/vendor/fontawesome-6/css/all.min.css')}}" rel="stylesheet" media="all">
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('image/admin.png')}}"  style="width:100px;">
