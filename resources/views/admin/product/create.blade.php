                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('product#create')}}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                <label class="control-label mb-1">Cateogory</label>
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaPrice" type="number" value="{{old('pizzaPrice')}}" class="form-control @error('pizzaPrice') is-invalid @enderror()" aria-required="true" aria-invalid="false" placeholder="Enter Your Price..." >
                                @error('pizzaPrice')
                                <div class="invalid-feedback">
                                     {{$message}}
                                </div>
